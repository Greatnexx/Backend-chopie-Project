...
import { createMenu, getMenus, getMenusByCategory, updateMenu, deleteMenu, getAllMenusForManagement, toggleMenuAvailability, getMenusByTable, getMenusByCategoryAndTable } from "../Controllers/menu.js";
...
router.delete("/menu/:id", deleteMenu); // Delete menu
